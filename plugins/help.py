        ...
        try:
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                     ...
                     [
                           InlineKeyboardButton("🧑‍💻Devloper🧑‍💻", url="https://t.me/DynamicHub")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Souce Code", url="https://github.com/Mr-Dynamic/Promoter")
                ],
                [
                    InlineKeyboardButton("Join Updates Channel", url="https://t.me/Dynamic_Studios"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Team_Dynamic")
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               client.send_message(
                   chat_id=message.chat.id,
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Dynamic_Studios).",
                   parse_mode="markdown",
                   disable_web_page_preview=True
               )
               return
